...
class BusRouteRecyclerViewAdapter(
    var routeInfoItemList: List<RouteInfoItem>,
    val context: Context
) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): BusRouteViewHolder {
        ...
        return BusRouteViewHolder(view, context)
    }
    ...
    class BusRouteViewHolder(view: View, context: Context) : RecyclerView.ViewHolder(view) {
